...
public class AudioTest extends JFrame implements MouseListener{
    ...
    public static void main(String[] args) {
        ...
        //创造一个实例
        AudioTest mr = new AudioTest();
        //调用录音的方法
        mr.capture();
        //记录开始录音的时间
        mr.startPlay = System.currentTimeMillis();
        ...
        //将其放到指定的路径下
        //定义最终要存放的文件路径
        String destPath = "audio/";
        mr.copyFile("audio2/", destPath);
...
//        //设置窗口上的图标
//        Image img = this.getToolkit().getImage("/img/234.jpg");
